...
class GradingJobBuilder:
  ...
  def create_grading_job(self, submission_id: int, grade_id: int, student_code: CodeFileInfo, grading_script: GradingScript) -> None:
    """
  ...
  def add_starter_code(self, starter_code: CodeFileInfo):
    self.__grading_job.set_starter_code(starter_code)

  def add_professor_code(self, professor_code: CodeFileInfo):
