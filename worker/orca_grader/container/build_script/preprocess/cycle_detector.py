...
class CycleDetector:
    ...
    def contains_cycle(json_script: List[GradingScriptCommandJSON]):
        ...
        adj_list, rev_adj_list = CycleDetector.generate_adjacency_lists_from_script(
            json_script)
        ...
        for vertex in adj_list:
            CycleDetector.visit_command(
                vertex, adj_list, visited, command_stack)
    ...
    def generate_adjacency_lists_from_script(json_script: List[GradingScriptCommandJSON]) \
        ...
        for i in range(len(json_script)):
            ...
            CycleDetector.append_edges_to_adjacency_lists(
                command, i, adj_list, rev_adj_list)
